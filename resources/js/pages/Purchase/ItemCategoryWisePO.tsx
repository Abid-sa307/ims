...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Item Category Wise Purchase Order',
        href: '/purchase/item-category-wise-po',
    },
];

export default function ItemCategoryWisePO() {
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Item Category Wise Purchase Order" />
            <div className="flex h-full flex-col p-4 sm:p-6 lg:p-8 overflow-y-auto bg-gray-50/50">

                {/* Header */}
                <div className="flex items-center justify-between border-b pb-4 mb-6">
                    <h1 className="text-xl font-bold tracking-tight text-[#162a5b]">Item Catgeory Wise Purchase Order</h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-8">
                        ...
                        <div className="flex items-end gap-0">
                            <div className="flex w-full overflow-hidden rounded-md border h-10">
                                ...
                                <Button className="flex-1 rounded-none bg-[#f15e3b] hover:bg-[#d94f2f] text-white h-full font-medium">Receive-Now</Button>
                            </div>
                        </div>
                        <div className="space-y-2 relative flex items-center h-10 border-b border-gray-200 group focus-within:border-blue-500">
                            <Label className="text-sm text-gray-600 w-24 shrink-0 font-normal">PO Date</Label>
