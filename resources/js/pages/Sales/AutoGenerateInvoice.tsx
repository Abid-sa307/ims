...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Auto Generate Sales Invoice',
        href: '/sales/auto-generate-invoice',
    },
];
...
export default function AutoGenerateInvoice() {
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Auto Generate Sales Invoice" />
            <div className="flex h-full flex-col p-4 sm:p-6 lg:p-8 bg-gray-50/50">
                ...
                <div className="flex items-center justify-between border-b border-orange-500/30 pb-4 mb-6 relative">
                    ...
                    <h1 className="text-lg font-bold tracking-tight text-[#162a5b]">Auto Generate Sales Invoice</h1>
                </div>
                        ...
                        <table className="w-full text-sm text-left align-middle">
                            <thead>
                                <tr className="border-b border-gray-200">
                                    ...
                                    <th className="px-4 py-3 font-medium text-gray-700 text-center w-40">Customer</th>
                                </tr>
                            </thead>
                            <tbody>
