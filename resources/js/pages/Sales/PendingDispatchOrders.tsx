...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    },
    {
        ...
        href: '/sales/pending-dispatch-orders',
    },
];

export default function PendingDispatchOrders() {
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Pending Dispatch Orders" />
            <div className="flex h-full flex-col p-4 sm:p-6 lg:p-8 bg-gray-50/50">

                {/* Header Section Matches Design */}
                <div className="flex items-center justify-between border-b pb-4 mb-6">
                    <h1 className="text-xl font-bold tracking-tight text-[#162a5b]">Pending Dispatch Orders</h1>
                ...
                <div className="bg-white rounded-md border shadow-sm flex flex-col mb-6">
                    ...
                    <div className="p-4 border-b border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                            ...
                            <div className="md:col-span-4 lg:col-span-3 space-y-2">
                                <Label className="text-xs text-muted-foreground font-normal">Customer</Label>
                                <select className="flex h-9 w-full rounded-md border border-gray-300 bg-white px-3 py-1 text-sm text-gray-700 shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500">
                            ...
                            <thead className="bg-white">
                                <tr>
                                    <th className="px-4 py-3 font-medium text-gray-600 border-b border-gray-200 whitespace-nowrap cursor-pointer">
                                        <div className="flex items-center justify-between gap-2">Dispatch <span className="text-[10px] text-gray-400">▲</span></div>
                                    </th>
                                    <th className="px-4 py-3 font-medium text-gray-600 border-b border-gray-200 whitespace-nowrap cursor-pointer">
                                    ...
                                    <th className="px-4 py-3 font-medium text-gray-600 border-b border-gray-200 whitespace-nowrap cursor-pointer">
                                        <div className="flex items-center justify-between gap-2">Customer <span className="text-[10px] text-gray-400 text-center leading-[0.5]">▲<br />▼</span></div>
                                    </th>
                                    <th className="px-4 py-3 font-medium text-gray-600 border-b border-gray-200 whitespace-nowrap cursor-pointer">
